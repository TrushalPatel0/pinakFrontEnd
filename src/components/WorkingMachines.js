...
const WorkingMachines = () => {
    ...
    const fetchMachines = async () => {
        try {
            const response = await axios.get(`${urll}show_working_machines/`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(
                `${urll}insert_update_working_machine/`,
                formData
            );
    ...
    const editDetailsGetData = async (id) => {
        try {
            const response = await axios.get(
                `${urll}insert_update_working_machine/?getdata_id=${id}`
            );
    ...
    const deleteData = async (id) => {
        try{
          const response = await axios.delete(
            `${urll}delete_working_machine/?working_machine_id=${id}`
          );
