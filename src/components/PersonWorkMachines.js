...
const PersonWorkMachines = () => {
  ...
  const fetchMachines = async () => {
    try {
      const response = await axios.get(`${urll}show_person_work_machine/`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${urll}insert_update_person_work_machine/`,
        formData
      );
  ...
  const editDetailsGetData = async (id) => {
    try {
      const response = await axios.get(
        `${urll}insert_update_person_work_machine/?getdata_id=${id}`
      );
  ...
  const deleteData = async (id) => {
    try{
      const response = await axios.delete(
        `${urll}delete_person_work_machine/?pwm_id=${id}`
      );
