...
function Bank_cash_insert({ fetchdata }) {
    ...
    const fetchBankCashData = async () => {
        try {
            const response = await axios.get(`${urll}show_bank_cash/`);
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mb-3">
                                    <label className="form-label">અમાઉન્ટ:</label>
                                    <input
                                        type="number"
                                        name="amount"
                                ...
                                <div className="mb-3">
                                    <label className="form-label">ડીટેલ :</label>
                                    <textarea
                                        name="details"
