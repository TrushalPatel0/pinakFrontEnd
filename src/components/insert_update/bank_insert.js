                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <form onSubmit={handleSubmit}>
                                <div className="mb-3">
                                    <label className="form-label">બૅંક નામ:</label>
                                    <input
                                        type="text"
                                        name="bank_name"
                                ...
                                <div className="mb-3">
                                    <label className="form-label">શાખા:</label>
                                    <input
                                        type="text"
                                        name="bank_branch"
                                ...
                                <div className="mb-3">
                                    <label className="form-label">એકાઉન્ટ નંબર:</label>
                                    <input
                                        type="text"
                                ...
                                <div className="mb-3">
                                    <label className="form-label">વ્યક્તિ</label>
                                    <select
                                        ...
                                        required
                                    >
                                        <option value="">વ્યક્તિ સિલેકટ કરો</option>
