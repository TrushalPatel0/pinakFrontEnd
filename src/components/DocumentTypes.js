...
const DocumentTypes = () => {
  ...
  const fetchDocumentTypes = async () => {
    try {
      const response = await axios.get(`${urll}show_document_types/`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${urll}insert_update_document_type/`,
        formData
      );
  ...
  const editDetailsGetData = async (id) => {
    try {
      const response = await axios.get(
        `${urll}insert_update_document_type/?getdata_id=${id}`
      );
  ...
  const deleteData = async (id) => {
    try{
      const response = await axios.delete(
        `${urll}delete_document_type/?document_type_id=${id}`
      );
