...
const WorkTypes = () => {
  ...
  const fetchWorkTypes = async () => {
    try {
      const response = await axios.get(`${urll}show_work_types/`);
  ...
  const editDetailsGetData = async (id) => {
    try {
      const response = await axios.get(
        `${urll}insert_update_work_type/?getdata_id=${id}`
      );
  ...
  const deleteData = async (id) => {
    try{
      const response = await axios.delete(
        `${urll}delete_work_type/?work_type_id=${id}`
      );
