...
const ProjectTypes = () => {
  ...
  const fetchProjectTypes = async () => {
    try {
      const response = await axios.get(`${urll}show_project_types/`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${urll}insert_update_project_type/`,
        formData
      );
  ...
  const editDetailsGetData = async (id) => {
    try {
      const response = await axios.get(
        `${urll}insert_update_project_type/?getdata_id=${id}`
      );
  ...
  const deleteData = async (id) => {
    try{
      const response = await axios.delete(
        `${urll}delete_project_type/?project_type_id=${id}`
      );
