...
const MachineTypes = () => {
  ...
  const fetchMachineTypes = async () => {
    try {
      const response = await axios.get(`${urll}show_machine_types/`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${urll}insert_update_machine_type/`,
        formData
      );
  ...
  const editDetailsGetData = async (id) => {
    try {
      const response = await axios.get(
        `http://pinak.matipro.in/insert_update_machine_type/?getdata_id=${id}`
      );
  ...
  const deleteData = async (id) => {
    try{
      const response = await axios.delete(
        `http://pinak.matipro.in/delete_machine_type/?machine_type_id=${id}`
      );
